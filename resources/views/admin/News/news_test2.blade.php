                                        ...
                                        <div class="tab-pane {{ $key == 0 ? 'active' : '' }}" id="{{ $value['languages_code'] }}_tap" role="tabpanel">
                                            ...
                                            <div class="form-horizontal form-upload">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" id="add_news_details_title"
                                                            name="news_details[{{ $value['languages_code'] }}][news_url]" placeholder="http://">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        ...
                                                        <select
                                                            ...
                                                            id="add_manager_id_{{ $value['languages_code'] }}" name="news_details[{{ $value['languages_code'] }}][news_category]" placeholder="Select">
                                                ...
                                                <div class="form-group row pb-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea class="form-control" id="add_news_details_description"
                                                            name="news_details[{{ $value['languages_code'] }}][news_short_description]" rows="4"></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row pb-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea class="form-control" id="add_news_details_content"
                                                            name="news_details[{{ $value['languages_code'] }}][news_content_details]" rows="4"></textarea>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-9">
                                                        <div class="custom-file">
                                                            <input type="file"
                                                                ...
                                                                id="add_news_banner_slide_image">
                                        ...
                                        <div class="tab-pane" id="gal-tap" role="tabpanel">
                                            <div class="form-horizontal form-upload">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control"
                                                            id="add_news_details_alt_text" name="news_gallery[add_news_details_alt_text]"
                                                            placeholder="">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" value="1"
                                                                ...
                                                                name="news[news_category_mata_robots][]">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="checkbox" class="toggle edit-status"
                                                        id="add_news_setting_banner" name="news[news_category_mata_robots]" checked
                                                        data-toggle="toggle" data-style="ios" data-on="On" data-off="Off">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="checkbox" class="toggle edit-status"
                                                        id="add_news_setting_gallery" name="news[news_category_mata_robots]" checked
                                                        data-toggle="toggle" data-style="ios" data-on="On" data-off="Off">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="checkbox" class="toggle edit-status"
                                                        id="add_news_setting_related_news" name="news[news_category_mata_robots]"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <div class="form-check pl-0 mt-2">
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input" value="4"
                                                                id="all" name="news[news_category_mata_robots]" checked>
                                                    ...
                                                    <div class="form-check pl-0 mt-2">
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input" value="4"
                                                                id="category" name="news[news_category_mata_robots]">
                                                    ...
                                                    <div class="form-check pl-0 mt-2">
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input" value="4"
                                                                id="keyword" name="news[news_category_mata_robots]">
                                                    ...
                                                    <div class="form-check pl-0 mt-2">
                                                        <div class="custom-control custom-radio">
                                                            <input type="radio" class="custom-control-input" value="4"
                                                                id="select" name="news[news_category_mata_robots]">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <div class="custom-file">
                                                                <input type="file"
                                                                    ...
                                                                    id="edit_news_banner_slide_image">
                                                                <label class="custom-file-label"
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="custom-file">
                                                        <input type="file"
                                                            ...
                                                            id="edit_news_category_og_twitter_image">
                                                        <label class="custom-file-label" for="validatedCustomFile">Choose
                                                            Image...</label>
                                                        <small class="form-text text-muted">Recommended Size: 1200 x 630
                                                            pixel</small>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="custom-file">
                                                        <input type="file"
                                                            class="custom-file-input edit-upload-news-category-img form-control"
                                                            id="edit_news_category_thumnail_image">
                                                        <label class="custom-file-label" for="validatedCustomFile">Choose
                                                            Image...</label>
                                                    </div>
                                                    <div class="card-body">
                                                ...
                                                <div class="form-horizontal form-upload">
                                                    <div class="row">
                                                        ...
                                                        <label class="col-sm-9 control-label col-form-label"
                                                            ...
                                                            หวานปนแซ่บ "ปราง กัญญ์ณรัณ" ควง "โต้ง ทูพี" ล่องทะเลภูเก็ต
                                                        </label>
                                                    </div>
                                                    <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <label for="add_news_details_content"
                                                            ...
                                                            Type</label>
                                                        <label class="col-sm-9 control-label col-form-label"
                                                            id="view_news_category_details_seo_type_{{ $value['languages_code'] }}">
                                                            ใช้ SEO หลัก </label>
                                                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            key_banner_gal++;
            $('body').on('click', '#add_banner_gal' + value.languages_code, function(e) {
                const news_banner_slide_image = $('#add_news_banner_slide_image_temp_' + value
                    .languages_code).val();
                const news_banner_slide_alt = $('#add_news_banner_slide_alt_' + value
                    .languages_code).val();
                ...
                if (news_banner_slide_image !== undefined) {
                    ...
                    let html = `<div class="col-md-6 col-sm-12 banner-img-` + value
                        .languages_code + `">
                                    <input type="hidden" id="languages_code" name="news_category_banner[` + value
                        .languages_code + `][` + key_banner_gal +
                        `][news_category_banner_slide_languages_code]" value="` + value
                        .languages_code + `">
                                    <input type="hidden" id="languages_id" name="news_category_banner[` + value
                        .languages_code + `][` + key_banner_gal + `][languages_id]" value="` + value
                        .languages_id +
                        `">
                                    <input type="hidden" class="form-control" id="add_news_category_banner_slide_image" name="news_banner_gal[` +
                        value.languages_code + `][` + key_banner_gal +
                        `][news_category_banner_slide_image]" value="` +
                        news_banner_slide_image +
                        `">
                                    <input type="hidden" class="form-control" id="add_news_category_banner_slide_alt" name="news_banner_gal[` +
                        value.languages_code + `][` + key_banner_gal +
                        `][news_category_banner_slide_alt]" value="` + news_banner_slide_alt +
                        `">
                                    <input type="hidden" class="form-control" id="add_news_category_banner_slide_url_slug" name="news_banner_gal[` + value.languages_code + `][` +
                                    key_banner_gal + `][news_category_banner_slide_url_slug]" value="` +
                        news_banner_slide_url_slug +
                        `">
                                    <input type="hidden" class="form-control" id="add_news_category_banner_slide_sort" name="news_banner_gal[` +
                        value.languages_code + `][` + key_banner_gal +
                        `][news_category_banner_slide_sort]" value="` + key_banner_gal + `">
                                    <div class="card  card-hover">
                                        <div class="text-right pt-2 pr-2">
                                            <a href="javascript:void(0)" class="confirm-delete-banner-` + value
                        .languages_code + `"><i class="ti-close"></i></a>
                    ...
                    $('#add_news_banner_slide_image').val('');
                    $('#add_news_banner_slide_image_txt').text(
                        'Choose Image...');
                    $('#add_news_banner_slide_image_temp').remove();
                    $('#add_news_banner_slide_alt').val('');
                    $('#add_news_banner_slide_url_slug').val('');
                    key_banner++;
                } else {
                    Swal.fire("Please select image!", 'Add unsuccessful', 'error');
                }
